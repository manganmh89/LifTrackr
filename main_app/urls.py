...
urlpatterns = [
    ...
    path('workouts/<int:workout_id>/add_exercise/<int:toy_id>/', views.add_exercise, name='add_exercise'),
    path('workouts/<int:workout_id>/remove_exercise/<int:toy_id>/', views.remove_exercise, name='remove_exercise'),
]